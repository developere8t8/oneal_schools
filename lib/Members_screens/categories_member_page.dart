...
import 'package:oneal_school/Members_screens/Widgets/category.dart';
import 'package:oneal_school/Members_screens/deposit_member_page.dart';
import 'package:oneal_school/Members_screens/home_member_page.dart';
import 'package:oneal_school/Widgets/small_btn.dart';
import 'package:oneal_school/chat_authentication/Screens/ChatRoom.dart';
import 'package:oneal_school/models/chatroom.dart';
import 'package:oneal_school/models/records.dart';
...
class _MyCategoriesState extends State<MyCategories> {
  ...
  num sum = 0;
  final List<Map> myProducts = List.generate(5, (index) => {"id": index, "name": ""}).toList();
                      ...
                      child: InkWell(
                        onTap: () async {
                          ...
                          if (snapchatroom.docs.isNotEmpty) {
                            ...
                            ChatroomModel model = ChatroomModel(id: newchatRoom.id, members: [
                              mydata[0].id,
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              'Chat With Admin',
                              style: TextStyle(color: Color(0xff83050C), fontSize: 17),
                            ),
                          ],
                        ),
                      ),
  ...
  Future getCatgeory() async {
    QuerySnapshot snap = await FirebaseFirestore.instance
        ...
        .get();
    List<RecordsData> alldata =
        snap.docs.map((e) => RecordsData.fromMap(e.data() as Map<String, dynamic>)).toList();
    setState(() {
