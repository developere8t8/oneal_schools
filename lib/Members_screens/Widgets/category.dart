...
import 'package:oneal_school/Members_screens/Widgets/pop_up_screen.dart';
import 'package:oneal_school/models/depositadd.dart';
...
class _CategoryWidgetState extends State<CategoryWidget> {
  ...
  Future getData() async {
    ...
    if (snap2.docs.isNotEmpty) {
      popUpData =
          snap2.docs.map((e) => DepositAddModel.fromMap(e.data() as Map<String, dynamic>)).toList();
