...
class _LogInMemberState extends State<LogInMember> {
  ...
  Future Login() async {
    try {
      ...
      final tokenupdate =
          FirebaseFirestore.instance.collection('Members').doc(FirebaseAuth.instance.currentUser!.uid);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(key: scaffold_key, backgroundColor: Colors.white, body: loginWidget());
  }
