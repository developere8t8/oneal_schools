...
import 'package:oneal_school/Admin_screens/Login/admin_setting_screen.dart';
...
import 'package:oneal_school/Admin_screens/all_member_creen/messege_screen.dart';
import 'package:oneal_school/Admin_screens/debit.dart';
import 'package:oneal_school/Admin_screens/deposit_alert_screen.dart';
...
import 'package:oneal_school/Admin_screens/search/search_data.dart';
...
class WelcomeBack extends StatefulWidget {
  String? userEmail;
  String? userPassword;
  WelcomeBack({this.userEmail, this.userPassword});
                ...
                if (snapshot.hasData) {
                  ...
                  return Column(
                    children: [
                          ...
                          if (snapshot.hasData) {
                            ...
                            return Stack(
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 21.0, right: 21, top: 115),
                                  child: InkWell(
                                    onTap: () {
                                      Navigator.push(
                                        context,
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          const Text(
                                            'Member Search',
                                            style: TextStyle(
                                                color: Color.fromRGBO(0, 0, 0, 0.3), fontSize: 20),
                                          ),
                                        ],
                                      ),
                                    ),
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 21.0, top: 15, right: 22),
                        child: Row(
                          children: [
                            Expanded(
                              child: InkWell(
                                onTap: () {
                                  Navigator.pushReplacement(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            TabMessage(docId: mydata[0].id, compId: mydata[0].id)),
                                  );
                                },
                                child: Container(
                                  ...
                                  if (snapshot.hasData) {
                                    final mydata = snapshot.data!.docs;
                                    {
                                      ...
                                      for (int j = 0; j < snapshot.data!.docs.length; j++) {
                                        tak = double.parse(mydata[j]['earning_balance'].toString());
                                        sum += tak;
                                      }
                                    }
                                    return Container(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 10.0, top: 68),
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        const Text(
