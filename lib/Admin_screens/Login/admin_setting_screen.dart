...
import 'package:oneal_school/Add_catageory/add_catogory.dart';
import 'package:oneal_school/Add_catageory/added_catagory.dart';
    ...
    return WillPopScope(
        child: Scaffold(
          appBar: AppBar(
            ...
            title: const Text(
              "ADMIN SETTINGS",
              style: TextStyle(color: Color(0xFFFFFFFF), fontWeight: FontWeight.w600, fontSize: 18),
            ),
            leading: IconButton(
              onPressed: () {
                          ...
                          child: Row(
                            ...
                            children: [
                              const Text(
                                ...
                                style: TextStyle(
                                    color: Color(0xff000000), fontSize: 15, fontWeight: FontWeight.w400),
                              ),
                            ],
                          ),
                        ),
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: '${mydata[0].get('Bank name')}',
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: '${mydata[0].get('Account Number')}',
                                        contentPadding: EdgeInsets.fromLTRB(10, 15, 0, 15),
                                        hintStyle: TextStyle(
                                            color: Color(0xffC4C4C4),
                                            fontSize: 15,
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: '${mydata[0].get('Account Holder Name')}',
                                        contentPadding: EdgeInsets.fromLTRB(10, 15, 0, 15),
                                        hintStyle: TextStyle(
                                            color: Color(0xffC4C4C4),
                                            fontSize: 15,
