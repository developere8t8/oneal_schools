...
class AdminChatHomeScreen extends StatefulWidget {
  AdminChatHomeScreen({required this.name, required this.compId, required this.docid});
  final String name;
  final String compId;
  final String docid;
                        ...
                        return Column(
                          ...
                          children: [
                            InkWell(
                              onTap: () {
                                String roomId =
                                    chatRoomId(FirebaseAuth.instance.currentUser!.uid, data![0].id);
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color: Color(0xff83050C), borderRadius: BorderRadius.circular(12)),
                                  child: Row(
