...
class TransactionCategoryWidget extends StatefulWidget {
  ...
  @override
  State<TransactionCategoryWidget> createState() => _TransactionCategoryWidgetState();
}
                    ...
                    children: [
                      if (widget.data!.transtype == 'Debit')
                        Text(
                          ...
                          style: TextStyle(
                              color: Color(0xff939393), fontSize: 16, fontWeight: FontWeight.w700),
                        ),
                        ...
                        children: [
                          if (widget.data!.transtype == 'Debit')
                            Text(
                              '\₦ ${amount}',
                              style: TextStyle(
                                  color: Color(0xffE83632), fontSize: 16, fontWeight: FontWeight.w600),
                            ),
                          if (widget.data!.transtype == 'Credit')
                            Text(
                              '\₦ ${amount}',
                              style: TextStyle(
                                  color: Color(0xff18D193), fontSize: 16, fontWeight: FontWeight.w600),
                            ),
                          SizedBox(
                            width: 5,
                          ),
